-- ============================================================
-- chat_adjuntos_continuar.sql
--
-- Continúa donde se quedó chat_adjuntos.sql: la tabla, los índices y
-- las políticas RLS YA SE APLICARON (venían antes del error). Esto retoma
-- desde la vista, ya corregida.
--
-- El error fue mío: usé i.fecha_cierre y esa columna no existe en
-- incidencias. Ahora los 2 días de gracia se miden desde la fecha del
-- archivo, que es un dato que sí tenemos.
-- ============================================================
